...
export default function AboutPage() {
  return (
    <div className="min-h-screen flex flex-col bg-cover bg-center"  style={{backgroundImage: "url('https://images.unsplash.com/photo-1470225620780-dba8ba36b745?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')" }}>
      ...
      <div className="relative z-10 flex-grow flex flex-col items-center justify-between px-4 py-16">
        <div className="w-full max-w-4xl mx-auto flex flex-col items-center justify-center flex-grow">
          <h1 className="text-5xl md:text-7xl font-bold text-white text-center mb-8 cursor-default">About EventPro</h1>
        </div>
        
        <Card className="w-full max-w-4xl mx-auto mb-8 bg-white/10 backdrop-blur-md border-none">
          <CardContent className="p-6">
            <p className="text-lg text-white text-center cursor-default">
